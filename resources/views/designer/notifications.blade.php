...
<head>
  <meta charset="UTF-8">
  <title>Notifikasi Designer</title>
...
<body>
  <div class="notif-wrapper">
    <div class="top-bar">
      <h3><i class="bi bi-bell-fill text-primary"></i> Notifikasi Designer</h3>
    ...
    <div class="notif-card" id="notif-comment-{{ $c->comment_id }}">
      ...
      @if($c->subtask)
        ...
        <div class="notif-meta">
          <i class="bi bi-kanban"></i> Card: <span class="fw-semibold text-dark">{{ $c->subtask->card->card_title }}</span>
        </div>
        @endif
    ...
    function dismiss(id) {
      ...
      .then(data => {
        if (data.success) {
          ...
          const badge = document.getElementById("designerNotifBadge");
          if (badge) {
